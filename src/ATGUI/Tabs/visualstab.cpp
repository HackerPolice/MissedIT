...
static void FilterEnemies()
{
	...
	ImGui::SameLine();
	ImGui::Combo(XORSTR("##BOXTYPEEnenemy"), (int *) &Settings::ESP::FilterEnemy::Boxes::type, BoxTypes,
	...
	ImGui::SameLine();
	ImGui::Combo(XORSTR("##TRACERTYPEEnenemy"), (int *) &Settings::ESP::FilterEnemy::Tracers::type, TracerTypes,
...
static void FilterAlise()
{
	...
	ImGui::Text(XORSTR("Box"));
	ImGui::SameLine();
	ImGui::Combo(XORSTR("##BOXTYPEAlise"), (int *) &Settings::ESP::FilterAlise::Boxes::type, BoxTypes,
	             IM_ARRAYSIZE(BoxTypes));
	...
	ImGui::Text(XORSTR("Chams"));
	ImGui::SameLine();
	ImGui::Combo(XORSTR("##CHAMSTYPEAlise"), (int *) &Settings::ESP::FilterAlise::Chams::type, chamsTypes,
	             IM_ARRAYSIZE(chamsTypes));
	...
	ImGui::SameLine();
	ImGui::Combo(XORSTR("##BARTYPEAlise"), (int *) &Settings::ESP::FilterAlise::HelthBar::type, BarTypes,
	             IM_ARRAYSIZE(BarTypes));
	...
	ImGui::Text(XORSTR("Tracers"));
	ImGui::SameLine();
	ImGui::Combo(XORSTR("##TRACERTYPEAlise"), (int *) &Settings::ESP::FilterAlise::Tracers::type, TracerTypes,
	             IM_ARRAYSIZE(TracerTypes));

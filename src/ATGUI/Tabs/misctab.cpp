	...
	ImGui::Columns(2, nullptr, true);
	{
		ImGui::BeginChild(XORSTR("Child1"), ImVec2(0, 0), true);
		{
			...
			if (Settings::ThirdPerson::enabled) {
				...
				{
					ImGui::PushItemWidth(-1);
					ImGui::SliderFloat(XORSTR("Camera Offset"), &Settings::ThirdPerson::distance, 0.f, 500.f,
	...
	ImGui::NextColumn();
	{
		ImGui::BeginChild(XORSTR("Child2"), ImVec2(0, 0), true);
		{
			...
			ImGui::NextColumn();
			{
				...
				if (ImGui::SliderInt(XORSTR("##ANIMATIONSPEED"), &Settings::ClanTagChanger::animationSpeed, 500,
				                     2000)) {
					ClanTagChanger::UpdateClanTagCallback();
				}
				ImGui::PopItemWidth();

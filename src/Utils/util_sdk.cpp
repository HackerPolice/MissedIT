...
IMaterial *Util::CreateMaterial(bool ignorez, std::string envmap, std::string envmaptint, int envmapfresnel,
...
IMaterial *
Util::CreateMaterial(std::string type, std::string texture, bool ignorez, bool nofog, bool model, bool nocull,
                     bool halflambert, std::string envmap, std::string envmaptint, int envmapfresnel,
                     std::string envmapfresnelminmaxexp)
{
	static int matNum = 1;
	std::stringstream materialData;
...
IMaterial *
Util::CreateMaterial2(std::string type, std::string texture, bool ignorez, bool nofog, bool model, bool nocull,
                      float alpha)
{
	static int matNum = 1;
	std::stringstream materialData;
...
IMaterial *
Util::CreateMaterial3(std::string type, std::string texture, bool ignorez, bool nofog, bool model, bool nocull,
                      float alpha, Vector color)
{
	static int matNum = 1;
	std::stringstream materialData;
	materialData << "\"" + type + "\"\n"
	                              "{\n"
	                              "\t\"$envmaptint\" \"" + "[" + std::to_string(1) + " " + std::to_string(0) + " " +
	                std::to_string(0) + "]" + "\"\n"
...
IMaterial *
Util::CreateMaterial4(std::string type, std::string texture, bool ignorez, bool nofog, bool model, bool nocull,
                      float alpha, Vector color)
{
	static int matNum = 1;
	std::stringstream materialData;
	materialData << "\"" + type + "\"\n"
	                ...
	                "[0 1 2]" + "\"\n"
	                            "\t\"$envmaptint\" \"" + "[" + std::to_string(color.x) + " " + std::to_string(color.y) +

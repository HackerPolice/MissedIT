...
namespace Entity
{
	...
	bool IsVisibleThroughEnemies(C_BasePlayer *player, int bone, bool smoke_check = false);
	bool IsSpotVisibleThroughEnemies(C_BasePlayer *player, Vector spot, bool smoke_check = false);
